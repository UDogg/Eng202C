...
\begin{itemize}
    ...
    \end{quote}
    \item \textbf{Linux (Ubuntu):} Reboot and hold \texttt{Shift} to access the GRUB menu (\href{https://askubuntu.com/questions/992877/understanding-the-options-in-the-grub-menu}{in example}), then select:
    \begin{quote}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth} % Width of the subfigure
        \includegraphics[width=\linewidth]{kaliclam.png} % Image 'a.png'
        \caption{Kali Linux Clam scan (zoom to read)} % Sub-caption for 'a.png'
        \label{fig:sub_a} % Label for subfigure 'a.png'
    \end{subfigure}
    \hfill % Horizontal space
    \begin{subfigure}[b]{0.48\textwidth} % Width of the subfigure
        \includegraphics[width=\linewidth]{kalirootkit.png} % Image 'b.png'
        \caption{Kali Linux rootkit scan (zoom to read)} % Sub-caption for 'b.png'
        \label{fig:sub_b} % Label for subfigure 'b.png'
    \end{subfigure}
    \label{fig:ab_images_subcaption} % Overall label
\end{figure}
